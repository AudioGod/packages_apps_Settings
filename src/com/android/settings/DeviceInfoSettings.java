...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
	...
	private static final String KEY_SSHD_VERSION = "sshd_version";  
	private static final String KEY_SSHD_BUILD_DATE = "build_date";  
    ...
    public void onCreate(Bundle icicle) {
		...
		setValueSummary(KEY_SSHD_VERSION, "ro.sshd.version");
		setValueSummary(KEY_SSHD_BUILD_DATE, "ro.build.date");  
